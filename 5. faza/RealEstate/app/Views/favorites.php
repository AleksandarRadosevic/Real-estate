...
<body><form id="my_form" method="get" action="/Guest/Add">
    <nav>
      ...
      <div class="logo"><h4><a href='../index.html'>Success</a></h4></div>
       ...
       <li><a href='/Guest/search' class="btn" style="background-color: rgb(33, 74, 255);">Pretraga</a href></li>
       <li><a href='/Guest/Ads'class="btn" style="background-color: rgb(33, 74, 255);">Oglasi</a href></li>
            <?php             
            if ($User==null) {
